...
echo_and_run cd "/home/simulations/public_sim_ws/src/all/turtle_3d/turtle_tf_3d"
...
echo_and_run /usr/bin/env \
    ...
    "/home/simulations/public_sim_ws/src/all/turtle_3d/turtle_tf_3d/setup.py" \
     \
    build --build-base "/home/simulations/public_sim_ws/build/all/turtle_3d/turtle_tf_3d" \
    install \
    --root="${DESTDIR-/}" \
