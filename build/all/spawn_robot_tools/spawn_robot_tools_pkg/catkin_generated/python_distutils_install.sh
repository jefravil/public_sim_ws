...
echo_and_run cd "/home/simulations/public_sim_ws/src/all/spawn_robot_tools/spawn_robot_tools_pkg"
...
echo_and_run /usr/bin/env \
    ...
    "/home/simulations/public_sim_ws/src/all/spawn_robot_tools/spawn_robot_tools_pkg/setup.py" \
     \
    build --build-base "/home/simulations/public_sim_ws/build/all/spawn_robot_tools/spawn_robot_tools_pkg" \
    install \
    --root="${DESTDIR-/}" \
