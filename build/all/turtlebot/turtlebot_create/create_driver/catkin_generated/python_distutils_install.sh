...
echo_and_run cd "/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_driver/setup.py" \
     \
    build --build-base "/home/simulations/public_sim_ws/build/all/turtlebot/turtlebot_create/create_driver" \
    install \
    --root="${DESTDIR-/}" \
