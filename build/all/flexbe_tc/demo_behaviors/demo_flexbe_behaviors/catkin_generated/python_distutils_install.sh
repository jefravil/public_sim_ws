...
echo_and_run cd "/home/simulations/public_sim_ws/src/all/flexbe_tc/demo_behaviors/demo_flexbe_behaviors"
...
echo_and_run /usr/bin/env \
    ...
    "/home/simulations/public_sim_ws/src/all/flexbe_tc/demo_behaviors/demo_flexbe_behaviors/setup.py" \
     \
    build --build-base "/home/simulations/public_sim_ws/build/all/flexbe_tc/demo_behaviors/demo_flexbe_behaviors" \
    install \
    --root="${DESTDIR-/}" \
