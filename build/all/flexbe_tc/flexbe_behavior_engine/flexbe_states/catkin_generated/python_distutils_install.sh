...
echo_and_run cd "/home/simulations/public_sim_ws/src/all/flexbe_tc/flexbe_behavior_engine/flexbe_states"
...
echo_and_run /usr/bin/env \
    ...
    "/home/simulations/public_sim_ws/src/all/flexbe_tc/flexbe_behavior_engine/flexbe_states/setup.py" \
     \
    build --build-base "/home/simulations/public_sim_ws/build/all/flexbe_tc/flexbe_behavior_engine/flexbe_states" \
    install \
    --root="${DESTDIR-/}" \
