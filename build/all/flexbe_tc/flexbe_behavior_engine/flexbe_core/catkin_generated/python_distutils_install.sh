...
echo_and_run cd "/home/simulations/public_sim_ws/src/all/flexbe_tc/flexbe_behavior_engine/flexbe_core"
...
echo_and_run /usr/bin/env \
    ...
    "/home/simulations/public_sim_ws/src/all/flexbe_tc/flexbe_behavior_engine/flexbe_core/setup.py" \
     \
    build --build-base "/home/simulations/public_sim_ws/build/all/flexbe_tc/flexbe_behavior_engine/flexbe_core" \
    install \
    --root="${DESTDIR-/}" \
