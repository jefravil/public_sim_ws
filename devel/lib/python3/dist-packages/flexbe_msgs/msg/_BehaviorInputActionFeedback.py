...
"""autogenerated by genpy from flexbe_msgs/BehaviorInputActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class BehaviorInputActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "flexbe_msgs/BehaviorInputActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','flexbe_msgs/BehaviorInputFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorInputActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = flexbe_msgs.msg.BehaviorInputFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = flexbe_msgs.msg.BehaviorInputFeedback()
