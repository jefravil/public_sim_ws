...
"""autogenerated by genpy from flexbe_msgs/BehaviorInputActionGoal.msg. Do not edit."""
import codecs
import sys
...
class BehaviorInputActionGoal(genpy.Message):
  _md5sum = "4fb958ec597ae0756978326ba2b4ac62"
  _type = "flexbe_msgs/BehaviorInputActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','flexbe_msgs/BehaviorInputGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorInputActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = flexbe_msgs.msg.BehaviorInputGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = flexbe_msgs.msg.BehaviorInputGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.request_type,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.msg = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.msg = str[start:end]
      return self
