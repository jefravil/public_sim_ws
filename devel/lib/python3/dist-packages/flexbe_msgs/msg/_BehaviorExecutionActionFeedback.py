...
"""autogenerated by genpy from flexbe_msgs/BehaviorExecutionActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class BehaviorExecutionActionFeedback(genpy.Message):
  _md5sum = "b767b030e0462dae1168f66f2dd64853"
  _type = "flexbe_msgs/BehaviorExecutionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','flexbe_msgs/BehaviorExecutionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorExecutionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = flexbe_msgs.msg.BehaviorExecutionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = flexbe_msgs.msg.BehaviorExecutionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.current_state = str[start:end].decode('utf-8', 'rosmsg')
      else:
