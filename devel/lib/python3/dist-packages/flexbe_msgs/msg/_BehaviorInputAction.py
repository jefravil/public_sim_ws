...
"""autogenerated by genpy from flexbe_msgs/BehaviorInputAction.msg. Do not edit."""
import codecs
import sys
...
class BehaviorInputAction(genpy.Message):
  _md5sum = "da5f1a9fbafffe8dfff69ff5a208dd99"
  _type = "flexbe_msgs/BehaviorInputAction"
...
"""
  ...
  _slot_types = ['flexbe_msgs/BehaviorInputActionGoal','flexbe_msgs/BehaviorInputActionResult','flexbe_msgs/BehaviorInputActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorInputAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = flexbe_msgs.msg.BehaviorInputActionGoal()
      if self.action_result is None:
        self.action_result = flexbe_msgs.msg.BehaviorInputActionResult()
      if self.action_feedback is None:
        self.action_feedback = flexbe_msgs.msg.BehaviorInputActionFeedback()
    else:
      self.action_goal = flexbe_msgs.msg.BehaviorInputActionGoal()
      self.action_result = flexbe_msgs.msg.BehaviorInputActionResult()
      self.action_feedback = flexbe_msgs.msg.BehaviorInputActionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.request_type,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.msg = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.msg = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_result.result.result_code,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.data = str[start:end]
      _x = self
      start = end
      end += 12
