...
"""autogenerated by genpy from flexbe_msgs/BehaviorExecutionActionResult.msg. Do not edit."""
import codecs
import sys
...
class BehaviorExecutionActionResult(genpy.Message):
  _md5sum = "76e505f84da88685989704705a0d9846"
  _type = "flexbe_msgs/BehaviorExecutionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','flexbe_msgs/BehaviorExecutionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorExecutionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = flexbe_msgs.msg.BehaviorExecutionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = flexbe_msgs.msg.BehaviorExecutionResult()
