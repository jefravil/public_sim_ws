...
"""autogenerated by genpy from robot_controllers_msgs/QueryControllerStatesActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class QueryControllerStatesActionFeedback(genpy.Message):
  _md5sum = "27d9ffea72fe024e2f600b8921a3f631"
  _type = "robot_controllers_msgs/QueryControllerStatesActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_controllers_msgs/QueryControllerStatesFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QueryControllerStatesActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = robot_controllers_msgs.msg.QueryControllerStatesFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_controllers_msgs.msg.QueryControllerStatesFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.feedback.state_diff)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.state_diff:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.feedback.state_diff.append(val1)
      return self
