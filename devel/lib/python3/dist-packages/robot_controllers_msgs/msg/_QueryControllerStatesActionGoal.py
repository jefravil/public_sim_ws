...
"""autogenerated by genpy from robot_controllers_msgs/QueryControllerStatesActionGoal.msg. Do not edit."""
import codecs
import sys
...
class QueryControllerStatesActionGoal(genpy.Message):
  _md5sum = "291a917d724f37ef2a137fb40fae4e4a"
  _type = "robot_controllers_msgs/QueryControllerStatesActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','robot_controllers_msgs/QueryControllerStatesGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QueryControllerStatesActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = robot_controllers_msgs.msg.QueryControllerStatesGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = robot_controllers_msgs.msg.QueryControllerStatesGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.goal.updates)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.updates:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
