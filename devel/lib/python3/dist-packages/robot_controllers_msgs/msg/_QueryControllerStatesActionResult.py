...
"""autogenerated by genpy from robot_controllers_msgs/QueryControllerStatesActionResult.msg. Do not edit."""
import codecs
import sys
...
class QueryControllerStatesActionResult(genpy.Message):
  _md5sum = "9a8e94275d921606c4552f40989a801e"
  _type = "robot_controllers_msgs/QueryControllerStatesActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_controllers_msgs/QueryControllerStatesResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QueryControllerStatesActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_controllers_msgs.msg.QueryControllerStatesResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_controllers_msgs.msg.QueryControllerStatesResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.state)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.state:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
