...
namespace create_node
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(TurtleBotConfig &config, const TurtleBotConfig &max, const TurtleBotConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const TurtleBotConfig &config1, const TurtleBotConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, TurtleBotConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const TurtleBotConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, TurtleBotConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const TurtleBotConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const TurtleBotConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, TurtleBotConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TurtleBotConfig::AbstractParamDescriptionConstPtr(new TurtleBotConfig::ParamDescription<std::string>("drive_mode", "str", 0, "The possible drive modes (twist, turtle, drive).", "{'enum': [{'name': 'twist', 'type': 'str', 'value': 'twist', 'srcline': 10, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'Takes a geometry_msgs/Twist message and is navigation compatible.', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'turtle', 'type': 'str', 'value': 'turtle', 'srcline': 11, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'Takes a create_node/Turtle message and is turtlesim compatible.', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'drive', 'type': 'str', 'value': 'drive', 'srcline': 12, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'Takes a create_node/Drive message which drives the TurtleBot as described in the iRobot Create manual.', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': ''}", &TurtleBotConfig::drive_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TurtleBotConfig::AbstractParamDescriptionConstPtr(new TurtleBotConfig::ParamDescription<double>("gyro_measurement_range", "double", 0, "Measurement range supported by gyro.", "{'enum': [{'name': 'ADXRS613', 'type': 'double', 'value': 150.0, 'srcline': 24, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'ADXRS613 150deg/s', 'ctype': 'double', 'cconsttype': 'const double'}, {'name': 'ADXRS652', 'type': 'double', 'value': 250.0, 'srcline': 25, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'ADXRS652 250deg/s', 'ctype': 'double', 'cconsttype': 'const double'}, {'name': 'ADXRS642', 'type': 'double', 'value': 300.0, 'srcline': 26, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'ADXRS642 300deg/s', 'ctype': 'double', 'cconsttype': 'const double'}], 'enum_description': 'Gyro Options'}", &TurtleBotConfig::gyro_measurement_range)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(TurtleBotConfig::AbstractParamDescriptionConstPtr(new TurtleBotConfig::ParamDescription<double>("gyro_measurement_range", "double", 0, "Measurement range supported by gyro.", "{'enum': [{'name': 'ADXRS613', 'type': 'double', 'value': 150.0, 'srcline': 24, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'ADXRS613 150deg/s', 'ctype': 'double', 'cconsttype': 'const double'}, {'name': 'ADXRS652', 'type': 'double', 'value': 250.0, 'srcline': 25, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'ADXRS652 250deg/s', 'ctype': 'double', 'cconsttype': 'const double'}, {'name': 'ADXRS642', 'type': 'double', 'value': 300.0, 'srcline': 26, 'srcfile': '/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg', 'description': 'ADXRS642 300deg/s', 'ctype': 'double', 'cconsttype': 'const double'}], 'enum_description': 'Gyro Options'}", &TurtleBotConfig::gyro_measurement_range)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const char * const TurtleBot_twist = "twist";
//#line 11 "/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const char * const TurtleBot_turtle = "turtle";
//#line 12 "/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const char * const TurtleBot_drive = "drive";
//#line 24 "/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const double TurtleBot_ADXRS613 = 150.0;
//#line 25 "/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg"
      const double TurtleBot_ADXRS652 = 250.0;
//#line 26 "/home/simulations/public_sim_ws/src/all/turtlebot/turtlebot_create/create_node/cfg/TurtleBot.cfg"
