...
bool operator==(const ::robot_controllers_msgs::ControllerState_<ContainerAllocator1> & lhs, const ::robot_controllers_msgs::ControllerState_<ContainerAllocator2> & rhs)
{
