...
bool operator==(const ::robot_controllers_msgs::QueryControllerStatesGoal_<ContainerAllocator1> & lhs, const ::robot_controllers_msgs::QueryControllerStatesGoal_<ContainerAllocator2> & rhs)
{
