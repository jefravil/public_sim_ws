...
if("TRUE" STREQUAL "TRUE")
  set(robot_controllers_interface_SOURCE_PREFIX /home/simulations/public_sim_ws/src/all/robot_controllers/robot_controllers_interface)
  set(robot_controllers_interface_DEVEL_PREFIX /home/simulations/public_sim_ws/devel)
  ...
  set(robot_controllers_interface_INSTALL_PREFIX /home/simulations/public_sim_ws/install)
...
if(NOT "/home/simulations/public_sim_ws/src/all/robot_controllers/robot_controllers_interface/include;/usr/include " STREQUAL " ")
  set(robot_controllers_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/simulations/public_sim_ws/src/all/robot_controllers/robot_controllers_interface/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_controllers_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simulations/public_sim_ws/src/all/robot_controllers/robot_controllers_interface/${idir}'.  ${_report}")
    endif()
    _list_append_unique(robot_controllers_interface_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "robot_controllers_interface;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robot_controllers_interface_NUM_DUMMY_TARGETS)
      set(robot_controllers_interface_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robot_controllers_interface::wrapped-linker-option${robot_controllers_interface_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robot_controllers_interface_NUM_DUMMY_TARGETS "${robot_controllers_interface_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robot_controllers_interface::wrapped-linker-option${robot_controllers_interface_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robot_controllers_interface_LIBRARIES "${interface_target_name}")
