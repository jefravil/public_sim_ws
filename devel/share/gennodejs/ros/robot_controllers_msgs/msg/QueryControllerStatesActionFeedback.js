...
class QueryControllerStatesActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new QueryControllerStatesFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = QueryControllerStatesFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new QueryControllerStatesActionFeedback(null);
    ...
    data.feedback = QueryControllerStatesFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += QueryControllerStatesFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new QueryControllerStatesActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = QueryControllerStatesFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new QueryControllerStatesFeedback()
    }
...
module.exports = QueryControllerStatesActionFeedback;
